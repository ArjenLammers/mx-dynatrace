...
Pod::Spec.new do |s|
  ...
  # --- Author --------------------------------------------------------- #
  #
  s.author             = { "Dynatrace" => "support.mobile@dynatrace.com" }
  s.social_media_url   = "https://twitter.com/dynatrace"

  # --- Source Location ---------------------------------------------------------- #
  #
  s.source       = { :http => "https://www.npmjs.com/package/@dynatrace/react-native-plugin" }
