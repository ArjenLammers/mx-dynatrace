...
const getCommandForRN60_0 = () => [patchCommand('instrument-dynatrace', 'Applies the Dynatrace configuration.', CommandType.Instrument)];
const getCommandForRN60_1 = () => [
...
else if ((0, semver_1.gte)(reactNativeVersionString, versionBoundary)) {
